...
<img src="./diagrams/Mediator.png" width="700px">

## Aplicabilidade

Use o Mediator quando:

- Quer diminuir ou extinguir o acoplamento direto entre as classes que poderiam estar diretamente acopladas.
- Quer simplificar comunicações de muitos-para-muitos para comunicações um-para-muitos;
